...
namespace ankit.az203.storage.tables
{
    public class Tables
    {
        private static string _connectionString = "DefaultEndpointsProtocol=https;EndpointSuffix=core.windows.net;AccountName=ankitaz203tables;AccountKey=Wod4ZeKxxWeBVaqW75c7wqxIzMiJ+eVBwetdGaiGGBp1r8jjYJSMgm1v4u58pJHZ5RRSf5NDGn/F080X3gvwDw==";
